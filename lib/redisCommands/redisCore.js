...
// redis v6 with redis stack add loadable module support with
// redisjson redissearch, redisgraph, redistimeseries, redisbloom
// https://redis.io/docs/stack/
const _readCmdsV6 = _readCmdsV4.concat([
