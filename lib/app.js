...
module.exports = function (httpServerOptions, _redisConnections, _appOptions) {
  ...
  app.use(`${urlPrefix}/jstree`, express.static(path.join(staticPath, '/jstree/dist')));
  app.use(`${urlPrefix}/clipboard`, express.static(path.join(staticPath, '/clipboard.js')));
...
function getIndexPage(req, res) {
    res.render('home/home.ejs', {
        ...
        httpAuthDisabled: req.app.locals.httpAuthDisabled
    });
}
