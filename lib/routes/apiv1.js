...
function saveKey (redisConnection, req, next, res) {
  ...
  redisConnection.type(key, function (err, type) {
    ...
    switch (type) {
      ...
      case 'list':
        return addListValue(redisConnection, key, value, 'lpush', req, res, next);
      case 'set':
        return addSetValue(redisConnection, value, req, res, next);
      case 'zset':
        return addSortedSetValue(redisConnection, key, score, value, req, res, next);
      default:
