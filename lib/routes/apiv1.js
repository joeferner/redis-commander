...
module.exports = function (app) {
  ...
  app.post('/apiv1/listvalue/:key',postAddListValue);
...
function postAddListValue(req,res,next){
  ...
  req.redisConnection.type(key, function(err,keyType) {
    if(!err && keyType != "list"){
    ...
    case 'lset' :
      return req.redisConnection.lset(key,req.body.index,value,callback);
    default: 
      err = "invalid type";
      console.error('addListValue',err);
      return next(err);
