...
module.exports = function (app) {
  ...
  routerV1.post('/key/:connectionId/:key(*)', _checkReadOnlyMode, postKey);
  routerV1.post('/keys/:connectionId/:key(*)', _checkReadOnlyMode, postKeys);

  // modify entries - legacy api
  routerV1.post('/listvalue/', _checkReadOnlyMode, postAddListValueOld);
  routerV1.post('/setmember/', _checkReadOnlyMode, postAddSetMemberOld);
  routerV1.post('/editListValue', _checkReadOnlyMode, postEditListValueOld);
  routerV1.post('/editSetMember', _checkReadOnlyMode, postEditSetMemberOld);
  routerV1.post('/editZSetMember', _checkReadOnlyMode, postEditZSetMemberOld);
  routerV1.post('/editXSetMember', _checkReadOnlyMode, postEditXSetMemberOld);
  routerV1.post('/editHashRow', _checkReadOnlyMode, postEditHashFieldOld);
  ...
  routerV2.post('/key/:connectionId/:key(*)', _checkReadOnlyMode, postKey);
  routerV2.post('/keys/:connectionId/:key(*)', _checkReadOnlyMode, postKeys);
  // modify entries - newer api with post/put/del and additional POST equivalents
  // and unified form params

  routerV2.post('/list/value', _checkReadOnlyMode, postAddListValue);
  routerV2.put('/list/value', _checkReadOnlyMode, postEditListValue);
  routerV2.delete('/list/value', _checkReadOnlyMode, postDeleteListValue);
  routerV2.post('/list/value/add', _checkReadOnlyMode, postAddListValue);
  routerV2.post('/list/value/edit', _checkReadOnlyMode, postEditListValue);
  routerV2.post('/list/value/delete', _checkReadOnlyMode, postDeleteListValue);

  routerV2.post('/set/member', _checkReadOnlyMode, postAddSetMember);
  routerV2.put('/set/member', _checkReadOnlyMode, postEditSetMember);
  routerV2.delete('/set/member', _checkReadOnlyMode, postDeleteSetMember);
  routerV2.post('/set/member/add', _checkReadOnlyMode, postAddSetMember);
  routerV2.post('/set/member/edit',_checkReadOnlyMode,  postEditSetMember);
  routerV2.post('/set/member/delete', _checkReadOnlyMode, postDeleteSetMember);

  routerV2.post('/zset/member', _checkReadOnlyMode, postAddZSetMember);
  routerV2.put('/zset/member', _checkReadOnlyMode, postEditZSetMember);
  routerV2.delete('/zset/member', _checkReadOnlyMode, postDeleteZSetMember);
  routerV2.post('/zset/member/add', _checkReadOnlyMode, postAddZSetMember);
  routerV2.post('/zset/member/edit', _checkReadOnlyMode, postEditZSetMember);
  routerV2.post('/zset/member/delete', _checkReadOnlyMode, postDeleteZSetMember);

  routerV2.post('/xset/member', _checkReadOnlyMode, postAddXSetMember);
  routerV2.put('/xset/member', _checkReadOnlyMode, postEditXSetMember);
  routerV2.delete('/xset/member', _checkReadOnlyMode, postDeleteXSetMember);
  routerV2.post('/xset/member/add', _checkReadOnlyMode, postAddXSetMember);
  routerV2.post('/xset/member/edit', _checkReadOnlyMode, postEditXSetMember);
  routerV2.post('/xset/member/delete', _checkReadOnlyMode, postDeleteXSetMember);

  routerV2.post('/hash/field', _checkReadOnlyMode, postAddHashField);
  routerV2.put('/hash/field', _checkReadOnlyMode, postEditHashField);
  routerV2.delete('/hash/field', _checkReadOnlyMode, postDeleteHashField);
  routerV2.post('/hash/field/add', _checkReadOnlyMode, postAddHashField);
  routerV2.post('/hash/field/edit', _checkReadOnlyMode, postEditHashField);
  routerV2.post('/hash/field/delete', _checkReadOnlyMode, postDeleteHashField);
...
function getRedisCommands(req, res) {
  if (req.app.locals.redisReadOnly) {
    res.json({"list": redisCoreCmds.readCmds});
  }
  else {
    res.json({"list": [].concat(redisCoreCmds.readCmds, redisCoreCmds.writeCmds)});
  }
}
...
function getKeyDetailsXSet (key, req, res, next) {
  ...
  if (typeof(startIdx) === 'undefined') {
    ...
    if (typeof(millis) === 'undefined' || isNaN(millis) < 0 || millis < 0
       || typeof(subMillis) === 'undefined' || isNaN(subMillis) < 0 || subMillis < 0)
    {
...
function postEditXSetMemberOld (req, res, next) {
  let key = req.body.xSetKey;
  let timestamp = req.body.zSetTimestamp;
  let field = req.body.zSetField;
  let value = req.body.zSetValue;
  let connectionId = req.body.zSetConnectionId;
  getConnection(req, res, function () {
    editXSetMember(key, timestamp, field, value, res, next);
  }, connectionId);
}
