...
module.exports = function (app) {
  ...
  // modify entries - legacy api
    routerV1.post('/listvalue/', postAddListValue);
    routerV1.post('/setmember/', postAddSetMember);
    routerV1.post('/editListRow', postEditListRow);
    routerV1.post('/editSetMember', postEditSetMember);
    routerV1.post('/editZSetRow', postEditZSetRow);
