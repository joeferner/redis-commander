...
| enableTLSForSentinelMode | boolean | false | --enable-sentinel-tls | SENTINEL_ENABLE_TLS | set to true if connecting to sentinel instances that are encrypted (https://github.com/luin/ioredis#sentinel) |
